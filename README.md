...
**Ver.0.64 対応について: 2026/06/23**  
06/19 に公開されたバージョン EA_0.64f にて、公式が日本語訳の大幅な更新をしてくださいました。  
当プロジェクトへの取り込みも順次進めていますが、差分が1万行超となっておりしばらく時間を要する見込みです。  
公式日本語訳も全体に質が高いものとなっていますので、しばらくは公式訳でのプレイをお願いいたします。  
